...
dict_dir = os.path.join(c_curr_dir, '../../data/segment_data/tencent')
...
detlog.info('[common_init] [tencent_segment] [init_flag=%s] [cost=%sms]' % (str(seg_flag), cost))
